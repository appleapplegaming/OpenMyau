...
public class Myau {
    ...
    public void init() {
        ...
        moduleManager.modules.put(AutoReply.class, new AutoReply());
        ...
        moduleManager.modules.put(KeyChat.class, new KeyChat());
        ...
        moduleManager.modules.put(QuickMaths.class, new QuickMaths());
